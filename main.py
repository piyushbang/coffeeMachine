...
vendingMachine.set_debug_mode(True)  # comment to hide request comment and process comments
...
vendingMachine.add_new_ingredient("green_mixture", 1000) # adding new ingredient for green tea
vendingMachine.refill_ingredient("sugar_syrup", 1000) # adding missing for green tea
vendingMachine.refill_ingredient("ginger_syrup", 1000) # adding missing for green tea
vendingMachine.refill_ingredient("hot_water", 1000) # adding missing for green tea
...
vendingMachine.make_beverage("green_tea")  # now green tea can be made.
vendingMachine.make_beverage("green_tea")  # now green tea can be made.
vendingMachine.make_beverage("green_tea")  # All outlet busy
